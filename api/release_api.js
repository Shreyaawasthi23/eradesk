...
export const createRelease = (release, router, onSuccess) =>
  postJson('/auth/itil/release/create', release, router, (data) => {
    Swal.fire('Success', data.message, 'success')
    onSuccess && onSuccess(data)
  })

export const editRelease = (release, router, onSuccess) =>
  postJson('/auth/itil/release/edit?id=' + release.id, release, router, onSuccess)

export const linkToRelease = (releaseId, entityType, entityId, router, onSuccess) =>
  postJson('/auth/itil/release/link?id=' + releaseId, { entityType, entityId }, router, onSuccess)

export const setReleaseStatus = (id, status, extra, router, onSuccess) =>
  postJson('/auth/itil/release/set-status?id=' + id, { status, ...extra }, router, onSuccess)
