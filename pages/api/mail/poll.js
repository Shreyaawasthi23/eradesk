...
// Background/webhook entry point for polling the support mailbox. No logged-in
// user is involved, so this is guarded by a shared secret instead of JWT auth.
export default async function handler(req, res) {
  ...
  try {
    const result = await pollSupportMailbox(db)
